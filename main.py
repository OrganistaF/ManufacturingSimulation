...
for i in range(100):
    ...
    #(9) 0.05 de probabilidad de defecto
    factory = Factory(env, num_workstations=6, failure_rates=failure_rates, work_time_mean=10, fix_time_mean=3, defect_rate=0.05)
    print("-------------------Results-------------------")
